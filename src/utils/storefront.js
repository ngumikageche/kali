...
export function normalizeProduct(product = {}) {
  ...
  return {
    ...
    productHref: publicSlug ? `/products/${publicSlug}` : product.id != null ? `/product/${product.id}/${slug}` : "",
    canonicalUrl: product.canonical_url || (publicSlug ? `/products/${publicSlug}` : product.id != null ? `/product/${product.id}/${slug}` : ""),
