  ...
  return (
    <section className="gallery">
      <div className="gallery-main">
        ...
        {showGalleryControls ? <button className="gallery-arrow left" onClick={() => move(-1)} aria-label="Previous image"><ChevronLeft /></button> : null}
        {showGalleryControls ? <button className="gallery-arrow right" onClick={() => move(1)} aria-label="Next image"><ChevronRight /></button> : null}
      </div>
      {showGalleryControls ? (
